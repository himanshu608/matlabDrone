...
%%
load('cur_env.mat',"agent");
load('cur_env.mat',"actInfo");
load('cur_env.mat',"actor");
load('cur_env.mat',"critic");
load('cur_env.mat',"env");
load('cur_env.mat',"agentOpts");
load('cur_env.mat',"numAct");
load('cur_env.mat',"numObs");
load('cur_env.mat',"obsInfo");
load('cur_env.mat',"trainOpts");
load('cur_env.mat',"trainingStats");
...
a.FontSize = 20;
%%
filename = './latestvid.avi';
target_fps = 50;
video_gen(fig, struct, filename, target_fps)
    %% 
save('new1_env.mat',"agent","actor","critic","numAct","numObs","actInfo","obsInfo","env","trainOpts","trainingStats","agentOpts")
